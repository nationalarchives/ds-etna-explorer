                    ...
                    <article>
                        ...
                        <div class="tna-page__entry">
                            ...
                            <div class="row featurette">
                                <div class="col-md-7">
                                    <h2 class="featurette-heading">Explore our top 100 records
                                    </h2>
                                    <p>Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper.
                                        ...
                                        commodo.</p>
                                    <a class="tna-button" href="#" id="disabled-button" disabled>Explore</a>
                                </div>
                                <div class="col-md-5">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title"><a href="/results.php?era=medieval">Medieval</a></h3>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title"><a href="/results.php?era=early-modern">Early modern</a></h3>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title"><a href="/results.php?era=empire-and-industry">Empire and Industry</a></h3>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title"><a href="/results.php?era=victorians">Victorians</a></h3>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title"><a href="/results.php?era=early-20th-century">Early 20th Century</a></h3>
                                        <h4 class="card-subtitle mb-2 text-muted">1901 - 1918</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title"><a href="/results.php?era=interwar">Interwar</a></h3>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title"><a href="/results.php?era=second-world-war">Second World War</a></h3>
                                        <h4 class="card-subtitle mb-2 text-muted">1939 - 1945</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title"><a href="/results.php?era=postwar">Postwar</a></h3>
